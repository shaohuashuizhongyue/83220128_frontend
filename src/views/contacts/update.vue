                    ...
                    <form class="form-horizontal"><!--role="form"-->
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="space-4"><input hidden v-model="contacts.id"/></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="请输入年龄" class="form-control col-xs-10 col-sm-5"
                                               v-model="contacts.age"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right"> 类型 </label>
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="请输入类型" class="form-control col-xs-10 col-sm-5"
                                               v-model="contacts.ctype"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right"> 性别 </label>
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="请输入性别" class="form-control col-xs-10 col-sm-5"
                                               v-model="contacts.sex"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="请输入联系方式" class="form-control col-xs-10 col-sm-5"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <quill-editor v-model="contacts.note"
                                                      ref="myQuillEditor"
                                                      class="editer"
    ...
    export default {
        ...
        mounted: function () {
            ...
            if (_this.loginUser.id != null) {
                _this.contacts = SessionStorage.get("CONTACTS");
            } else {
        ...
        methods: {
            ...
            save() {
                let _this = this;
                // 保存校验
                if (!Validator.require(_this.contacts.name, "姓名")) {
                    return;
                }
                if (!Validator.require(_this.contacts.age, "年龄") || !Validator.checkAge(_this.contacts.age, "年龄")) {
                    return;
                }
                if (!Validator.require(_this.contacts.ctype, "类型")) {
                    return;
                }
                if (!Validator.require(_this.contacts.sex, "性别")) {
                    return;
                }
                if (!Validator.require(_this.contacts.tel, "联系方式") || !Validator.checkTel(_this.contacts.tel, "联系方式")) {
                    return;
                }
                if (!Validator.require(_this.contacts.address, "地址")) {
                    return;
                }
                //Loading.show();
                _this.$ajax.post(_this.$javaurl + "/admin/contacts/save", _this.contacts).then((response) => {
                    // Loading.hide();
