                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="请输入类型:特别重要/较重要/重要/一般/不重要等"
                                               class="form-control col-xs-10 col-sm-5"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select v-model="contacts.sex" class="form-control">
    ...
    export default {
        ...
        methods: {
            ...
            save() {
                ...
                if (!Validator.require(_this.contacts.tel, "联系电话") || !Validator.checkTel(_this.contacts.tel, "联系电话")) {
                    return;
                }
                _this.contacts.uid=_this.loginUser.id;
